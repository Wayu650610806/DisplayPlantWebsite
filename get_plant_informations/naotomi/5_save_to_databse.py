...
def show_images_in_folder(folder: str, output_folder: str, status_template_dir: str):
    ...
    # --- โหลด Metadata ---
    timestamp_json_path = os.path.join(output_folder, "timestamps.json"); all_timestamps = {}
...
if __name__ == "__main__":
    input_folder = r"C:\Project\DisplayPlantWebsite\uploaded_images\fix"
    output_folder = r"C:\Project\DisplayPlantWebsite\informationJson" # แก้ Path ตามที่คุณใช้
    status_template_dir = r"C:\Project\DisplayPlantWebsite\informationJson\status1" # แก้ Path ตามที่คุณใช้
